...
class SimulatorView(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.POST.get("created_at_wind_speed"):
            post_created_at = request.POST.get("created_at_wind_speed")
            post_wind_speed = request.POST.get("wind_speed")
            wind_data = WindSpeedSensor(
                created_at=post_created_at, wind_speed=post_wind_speed
            )
            wind_data.save()
    ...
    def get(self, request, *args, **kwargs):
        ...
        form_wis = WindSpeedForm(initial=initial_data)
        context = {
            "form_temp": form_temp,
